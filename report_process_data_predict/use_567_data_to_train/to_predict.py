...
dir_path = os.path.dirname(root_path + "report_process_data_predict/use_456_data_to_train/savemodel/")
...
canada_housing_data = pd.read_csv('./input/train_567_month_delisting.csv')
