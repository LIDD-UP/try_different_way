...
@file: standard_data_to_predict.py
@time: 2018/9/12
"""
...
dir_path = os.path.dirname(root_path + "report_process_data_predict/predict_test_save_model2/")
...
standard_data1 = StandardScaler()
canada_housing_data = standard_data1.fit_transform(canada_housing_data)
...
standard_data2 = StandardScaler()
predict_data = standard_data2.fit_transform(predict_data)
print(predict_data.head())
