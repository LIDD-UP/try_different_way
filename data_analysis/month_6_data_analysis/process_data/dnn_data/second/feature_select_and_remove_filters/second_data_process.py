...
# print(data.head())
# data = data.drop(columns=['parkingSpaces','bedrooms','washrooms','totalParkingSpaces','garageSpaces'])
data = data.drop(columns=['totalParkingSpaces',])

data['parkingSpaces'] = data['parkingSpaces'].astype(str)
data['bedrooms'] = data['bedrooms'].astype(str)
data['washrooms'] = data['washrooms'].astype(str)
# data['totalParkingSpaces'] = data['totalParkingSpaces'].astype(str)
...
data = data[['bedrooms', 'community',  'drive',
 'latitude',  'longitude' , 'lotDepth',
 'lotFront',  'parkingSpaces',  'price',
  'room1',  'room4', 'room6',  'rooms',
  'rooms1square',  'rooms2square',  'rooms3square',
    'rooms4square', 'rooms5square', 'rooms6square','daysOnMarket','buildingTypeId']]

# data=data[['airConditioning', 'bedrooms',
# 'community',  'drive',  'frontingOn',  'garageSpaces',  'garageType',
#  'parkingSpaces', 'price',  'room1',  'room3', 'room4','room5',
#  'room6' ,'rooms', 'rooms1square',  'rooms2square','rooms3square',
#  'rooms4square',  'rooms5square',  'rooms6square',  'sewers', 'style',
# 'taxes',  'washrooms','daysOnMarket']]
...
'''
[(1, 'bedrooms'), (1, 'community'), (1, 'latitude'), (1, 'longitude'),
 (1, 'lotDepth'), (1, 'lotFront'), (1, 'price'), (1, 'room6'), (1, 'rooms1square'),
  (1, 'rooms2square'), (1, 'rooms3square'), (1, 'rooms4square'), (1, 'rooms5square'),
   (1, 'rooms6square'), (1, 'taxes')
'''

'''
(1, 'bedrooms'), (1, 'community'), (1, 'drive'), 
(1, 'latitude'), (1, 'longitude'), (1, 'lotDepth'),
 (1, 'lotFront'), (1, 'parkingSpaces'), (1, 'price'), 
 (1, 'room1'), (1, 'room4'), (1, 'room6'), (1, 'rooms'),
  (1, 'rooms1square'), (1, 'rooms2square'), (1, 'rooms3square'),
   (1, 'rooms4square'), (1, 'rooms5square'), (1, 'rooms6square')
'''
