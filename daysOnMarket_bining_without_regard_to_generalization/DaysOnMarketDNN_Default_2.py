...
dir_path = os.path.dirname(root_path + "predict_test_save_model/")
...
# canada_housing_data = pd.read_csv(root_path + "house_info_2018-07_delisting.csv", sep=",")
...
canada_housing_data = data_process_before(predict_data)
