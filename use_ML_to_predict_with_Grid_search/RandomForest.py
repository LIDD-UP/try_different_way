...
# 寻找超参数
params = {"n_estimators":[x for x in range(1,1000,1)],'max_depth':[x for x in range(1,100,1)],'max_features':[x for x in range(1,7,1)]}
grid = GridSearchCV(estimator=RandomForestRegressor(),param_grid=params,scoring='neg_mean_absolute_error')
