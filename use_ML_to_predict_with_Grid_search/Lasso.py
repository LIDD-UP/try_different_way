...
# 寻找超参数
params = {"alpha":np.logspace(-5,1,10000)}
print(len(np.logspace(-5,1,10)))
grid = GridSearchCV(estimator=Lasso(),param_grid=params,scoring='neg_mean_absolute_error')
...
plt.title("Lasso preds and true daysOnMarket distribution circumstance")
plt.legend()
plt.show()
'''
error 9.600871004253207
pred_mean 21.167238371920618
