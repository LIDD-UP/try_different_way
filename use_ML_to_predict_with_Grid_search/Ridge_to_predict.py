...
# 寻找超参数
params = {"alpha":np.logspace(-5,3,10000)}
...
plt.title("Ridge preds and true daysOnMarket distribution circumstance")
plt.legend()
plt.show()
'''
error 9.600849870428583
pred_mean 21.16718426505714
