...
if __name__ == '__main__':
    ...
    # # # 处理ownerShipType
    train_data,test_data = get_category_class_bigger_than_threshold_value_ownerShipType(train_data,test_data,'ownerShipType',1000)
    # # # 处理bedrooms
    train_data, test_data = get_category_class_bigger_than_threshold_value_bedrooms(train_data,test_data,'bedrooms',10000)
    # # # 处理bathroomTotal
