...
dir_path = os.path.dirname(root_path + "first_reporter_task_one_week_finish/month_67_delisting_data_prediction/savemodel2/")
...
canada_housing_data = pd.read_csv('./input/month_67_trian_after_process_1.csv')
