...
train_data  = pd.read_csv('./input/month_567_d_more_columns.csv')
...
# 用listingdate分开数据进行预测加权重；


print(train_data.head())
train_data_new_index = []

for index,value in enumerate(train_data['listingDate']):
    if('2018' in value ):
        # print(index)
        train_data_new_index.append(index)

train_data_new = train_data[train_data.index.isin(train_data_new_index)]
# print(train_data_new['listingDate'])
print(train_data_new.shape)
train_data_inverse = train_data[~train_data.index.isin(train_data_new_index)]
...
train_data_new.to_csv('./input/listing_18.csv',index=False)
train_data_inverse.to_csv('./input/listing_17.csv',index=False)
