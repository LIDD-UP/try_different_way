...
if __name__ == '__main__':
    ...
    df_train = pd.read_csv('./input/month_567_d_more_columns.csv')
    ...
    ml_predictor.train(df_train,model_names='GradientBoostingRegressor')
    ...
    merge_data_df.to_csv('./merge_data_bak/merge_data_auto_ml_test_gbdt.csv',index=False)
