...
dir_path = os.path.dirname(root_path + "first_reporter_task_one_week_finish/month_2to7_delisting_data_prediction/savemodel2/")
...
canada_housing_data = pd.read_csv('./input/month_2to7_delistingDate_train_after_process_2.csv')
...
predict_data = pd.read_csv('../prediction_data/month_8_data_after_process_1.csv')
