...
# 根目录
root_path = "/Users/saninco/Desktop/Python/Tensorflow/"

# Model存储路径
# dir_path = os.path.dirname(root_path + "daysOnMarketTraining/trainingModels/DaysOnMarketDNN_Default_1/bak_9")
dir_path = os.path.dirname(root_path + "prediction_test")
...
# train data
canada_housing_data = pd.read_csv(root_path + "house_info_2018_2.csv", sep=",")
# predict data

predict_data = pd.read_csv('./predict_day1.csv')
predict_data = predict_data.dropna()
print('predict data',predict_data.head())
# predict_data = predict_data.drop(columns='realtorDataId')
origin_data = predict_data



# predict data
bedrooms_list_predict = []
for bedrooms_predict in predict_data['bedrooms']:
    bedrooms_list_predict.append(int(eval(bedrooms_predict)))
predict_data["bedrooms"] = bedrooms_list_predict


# predict data
bathroom_total_list_predict = []
for bathroom_total_predict in predict_data["bathroomTotal"]:
    bathroom_total_list_predict.append(int(bathroom_total_predict))
predict_data["bathroomTotal"] = bathroom_total_list_predict
